...
\indent \textit{Windows only} --- \href{}{\textbf{setuptools}}: A Python module for installing the \oscaar package\\
...
\subsection{Planning Your Observing: Transit Predictions}
