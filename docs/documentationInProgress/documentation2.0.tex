...
%  - write up subsection on multiple apertures in the GUI section
%  - write up subsection on multiple regions files in the GUI section
%  - draw more "cheat sheet" tables of acceptable values
%  - write up subsection on the "extra observatory params" box (cut and paste the subsection on CCD Gain, add time keyword subsection)
...
$\gamma_1$ and $\gamma_2$, the limb-darkening coefficients, parameterize the profile of the stellar brightness as it increases from the limb towards the center of the star.\\

\noindent A planetary system can be described with additional parameters if, for example, if the orbit has non-zero eccentricity. 
