...
class starBank:
    ...
    def __init__(self,regsPath):
        ...
        for i in range(0,len(init_x_list)):
            self.allStarsDict[paddedStr(i,3)] = {}
            self.allStarsDict[paddedStr(i,3)]['x-pos'] = [init_x_list[i]]
            self.allStarsDict[paddedStr(i,3)]['y-pos'] = [init_y_list[i]]
