...
\caption{Trying a range of \code{Smoothing Constant} values from 0 to 3.}
...
\caption{\code{Track plots} set to \code{True} and \code{Photometry plots} set to \code{False}.}
...
Drake Deming, Avi Mandell, Elizabeth Warner, Alberto Bolatto, Harley Katz, Jacob Endres, Daniel Galdi, Sam Gross, Luuk Visser.
